...
export default function WeatherCard({ weather, weatherTip }) {
  ...
  return (
    <div className="bg-(--surface) border border-(--border) rounded-xl p-6 shadow-sm">
      <div className="flex flex-col items-center sm:items-start">
        ...
        {/* Weather tip lives inside the card, below conditions */}
        {weatherTip && (
          <p className="mt-3 text-sm text-(--muted-foreground) italic border-t border-(--border) pt-3 w-full">
            {weatherTip}
          </p>
        )}
      </div>
